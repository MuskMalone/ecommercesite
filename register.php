...
function validateForm()
{
    ...
    if (document.register.pwdanswer.value == "" && document.register.pwdquestion.value != ""){
...
$MainContent .= "<div class='col-sm-9'>";
$MainContent .= "<input class='form-control' name='pwdquestion' id='pwdquestion' type='text' />";
$MainContent .= "</div>";
$MainContent .= "</div>";
$MainContent .= "<div class='form-group row'>";
